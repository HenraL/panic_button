...
| 1 | U7 | DW01A (protection IC) | $0.05–0.15 | **BMS toggle — populate only for a bare cell without internal protection PCB** (jumper bridged + U7/U8 absent = default) |
| 1 | U8 | 8205A dual N-MOSFET (SOT-23-6) | $0.07–0.15 | same toggle as U7; unpopulated by default |
...
| 1 | – | 2-pad solder jumper (bridged) | $0.05–0.10 | P_NEG ↔ GND — the BMS toggle itself |
...
19-08-2026: U1 (SIM7670G), U2 (LIS2DW12), U3 (ME6211), U4 (TPS61022), U5 (ESP32-C3),
U6 (TP4056), U7 (DW01A), U8 (8205A), Q1 (Si2305CDS), SW4, BT1, J1, J2, J3, LED1/LED2,
R6–R9 placed. U7/U8/Q1 remain unwired (BMS toggle + reverse protection).
