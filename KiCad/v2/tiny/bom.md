...
| 1 | U8 | TP4056-42-ESOP8 (charger) | $0.15–0.40 | placed as U8 on the Li-ion subsheet; CHRG/STDBY open-drain outputs drive the status LEDs (LED1/LED2) |
| 1 | U6 | DW01A (protection IC) | $0.05–0.15 | **always populated** — enabled/disabled by the toggle jumper on its GND pin (open = battery has its own BMS, closed = bare cell) |
| 1 | U7 | 8205A dual N-MOSFET (SOT-23-6) | $0.07–0.15 | **always populated** — the only cell − → GND path; gates held on by R12/R13 pull-ups when the DW01A is unpowered |
...
| 2 | TP_sw | 2× TestPoint_1.25mm pads facing each other | $0.02 | U6 GND ↔ cell − — the DW01A-enable toggle (µA); ships OPEN (with-BMS default), solder bridge = closed |
...
19-08-2026 (16:37 save): U1 (SIM7670G), U2 (LIS2DW12), U3 (ME6211), U4 (TPS61022), U5 (ESP32-C3),
U6 (DW01A), U7 (8205A), U8 (TP4056), Q1 (Si2305CDS), SW4, BT1, J1, J2, J3, LED1/LED2,
R6–R9 placed (Q2 removed; refs renumbered 16:09 — TP4056 U6→U8, 8205A U8→U7, DW01A U7→U6).
U6/U7 protection pair wired ✓ (re-verified 16:37); the UART section moved to its own
`uart` sheet (J3, TP8–TP13, R10/R11) — needs brains labels; the cell-side net, the
